...
set rc [catch {
  open_project {uart.prj}
  import_device eagle_s20.db -package EG4S20BG256
  import_db {../syn_1/uart_gate.db}
  config_chipwatcher "../../uart.cwc" -dir ""
  compile_watcher
  place
  export_db {uart_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file uart_phy.area
  export_db {uart_pr.db}
} RESULT]
if {$rc} {
